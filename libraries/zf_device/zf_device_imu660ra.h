...
#define IMU660RA_ACC_SAMPLE           (0x01)                                      // 加速度计量程
...
#define IMU660RA_GYR_SAMPLE           (0x01)                                      // 陀螺仪量程
...
//===============================================声明 IMU660RA 数据存储变量===============================================
extern int16 imu660ra_gyro[3];                   // 三轴陀螺仪数据      gyro (陀螺仪)
extern int16 imu660ra_acc[3];                    // 三轴加速度计数据     acc (accelerometer 加速度计)
//===============================================声明 IMU660RA 数据存储变量===============================================

//==================================================IMU660RA 基础函数==================================================
void  imu660ra_get_acc            (void);                                         // 获取 IMU660RA 加速度计数据
void  imu660ra_get_gyro           (void);                                         // 获取 IMU660RA 陀螺仪数据
float imu660ra_acc_transition     ();                              // 将   IMU660RA 加速度计数据转换为实际物理数据
float imu660ra_gyro_transition    ();                             // 将   IMU660RA 陀螺仪数据转换为实际物理数据
