...
int16 imu660ra_gyro[3]={0};                           // 三轴陀螺仪数据      gyro (陀螺仪)
int16 imu660ra_acc[3]={0};                              // 三轴加速度计数据     acc (accelerometer 加速度计)
...
void imu660ra_get_acc (void)
{
    ...
    imu660ra_acc[0] = (int16)(((uint16)dat[1]<<8 | dat[0]));
    imu660ra_acc[1] = (int16)(((uint16)dat[3]<<8 | dat[2]));
    imu660ra_acc[2] = (int16)(((uint16)dat[5]<<8 | dat[4]));
}
//-------------------------------------------------------------------------------------------------------------------
...
void imu660ra_get_gyro (void)
{
    ...
    imu660ra_gyro[0] = (int16)(((uint16)dat[1]<<8 | dat[0]));
    imu660ra_gyro[1] = (int16)(((uint16)dat[3]<<8 | dat[2]));
    imu660ra_gyro[2] = (int16)(((uint16)dat[5]<<8 | dat[4]));
}
